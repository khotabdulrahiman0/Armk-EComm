...
const OrderDetailsPage = () => {
    ...
    useEffect(()=>{
        const mockOrderDetails={
            ...
            shppingAddress:{city:"New York",country:"USA"},
            orderItems:[
                {
                    productId:"1",
                    name:"Jacket",
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 sm:p-6 '>
        ...
        {!orderDetails ? (<p>No Order Details Found</p>):(<div className='p-4 sm:p-6 rounded-lg border'>
            ...
            {/* Customer , payment , shipping infor */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8 ">
                ...
                <div className="sd">
                    ...
                    <p className=''>Shipping Method: {orderDetails.shppingMethod}</p>
                    <p> Address: {`${orderDetails.shppingAddress.city},${orderDetails.shppingAddress.country}`}</p>
                </div>
            </div>
